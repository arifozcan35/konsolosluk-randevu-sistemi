...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback, GoogleMap.OnMapLongClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnSaveMap.isEnabled = false
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        if (info == "new"){
            binding.btnSaveMap.visibility = View.VISIBLE
            binding.btnDeleteMap.visibility = View.GONE
        ...
        // eski ise
            ...
            placeFromMain?.let {
                ...
                binding.btnSaveMap.visibility = View.GONE
                binding.btnDeleteMap.visibility = View.VISIBLE
    ...
    override fun onMapLongClick(p0: LatLng) {
        ...
        binding.btnSaveMap.isEnabled = true
    }
